...
$(document).ready(function () {
	...
	// Countdown //
	$('#countdown').countdown({
		until: new Date(2015, 11 - 1, 18, 9), // new Date(year, mth - 1, day, hr, min, sec) - date/time to count down to 
	...
	// Google Map //
	$('#map_canvas').gmap({
		'center': new google.maps.LatLng(51.511643, -0.071934), // Change this to your desired latitude and longitude
		'zoom': 17,
	...
	$('#map_canvas').gmap().bind('init', function () {
		$('#map_canvas').gmap('addMarker', {
			'id': 'marker-1',
			'position': '51.511643, -0.071934',
			'bounds': false,
			'icon': image
		}).click(function () {
			$('#map_canvas').gmap('openInfoWindow', {
				'content': '<h4>Global Innovation Forum</h4><p><strong>Grange Tower Bridge Hotel</strong><br>45 Prescot St, London E1 8GP</p>'
			}, this);
		});
	});
